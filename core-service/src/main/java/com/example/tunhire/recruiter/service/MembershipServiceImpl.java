...
import com.example.tunhire.recruiter.repository.CompanyMembershipRepository;
...
public class MembershipServiceImpl implements MembershipService {
    ...
    public MembershipResponse addMember(Long companyId, MembershipRequest request, Long currentUserId) {
        ...
        CompanyMembership newMember = new CompanyMembership(company, request.userId(), request.role());
